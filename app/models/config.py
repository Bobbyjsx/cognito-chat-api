...
class AppConfigDB(BaseModel):
    ...
    models_list: dict[str, TextModelConfig] = Field(
        default_factory=lambda: {
            ...
            "claude-sonnet-4-5": TextModelConfig(
                description="Anthropic's flagship model with industry-leading intelligence for coding, research, and agents",
                enabled=True,
                reasoning_modes=[
                    ReasoningLevel.FAST,
                    ReasoningLevel.BALANCED,
                ...
                context_score=0.98,
                vision_score=0.95,
                tool_calling_score=0.98,
                structured_output_score=0.96,
                speed_score=0.75,
                quality_score=0.98,
